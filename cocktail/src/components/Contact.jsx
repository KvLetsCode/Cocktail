...
const Contact = () => {
    useGSAP(() => {
        ...
        timeline
            ...
            .from('#contact h3 , #contact p', { opacity: 1, yPercent: 100, stagger: 0.08 })
          ...
          <h3>OPEN EVERY DAY</h3>
              ...
              <div>
                  ...
                  <div className="flex-center gap-5">
                      {socials.map((social) => (
                          <a href={social.icon} key={social.name} target="_blank" rel="noopener noreferrer" aria-label={social.name}>
